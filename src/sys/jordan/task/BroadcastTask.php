...
class BroadcastTask extends PluginTask{
	...
	public function onRun($currentTick){
		$messages = ["Use /scenarios to see the scenarios that are active!", "Check out ".Central::$TWITTER." for upcoming UHCs!", "Use /stats to check out your stats!", "Report any bugs to admins so we can fix them!"];

	...
	public function handleCountdown(){
		...
		switch($this->countdown){
			...
			case 80:
				...
				break;
			case 60:
				$this->broadcastMessage(Central::PREFIX.TextFormat::GRAY." Welcome to".Central::$BRAND_PREFIX."!");
				break;
			case 55:
			...
			case 20:
				...
				break;
			case 15:
				$this->broadcastMessage(Central::PREFIX.TextFormat::GRAY." Follow".TextFormat::BLUE.Central::$TWITTER.TextFormat::GRAY."for new features.");
				break;
			case 10:
	...
	public function testPlayers(){
		if($this->plugin->getEventManager()->getEvent() > 0){
			if($this->getPlugin()->getTeamManager()->isTeamsEnabled()){
				...
				if(($this->getPlugin()->getEssentialManager()->getPlayerCount() === 1)) {
					$this->endCounter--;
					foreach ($this->plugin->getPlayers() as $player) {

...
class TeamManager {
	...
	public static $MAX_TEAM_COUNT = 2;
	...
	/**
	 * @param ParadoxPlayer[] $players
	 */
	public function createTeam(array $players){
		$team = new Team($this->getTeamsCount() + 1, $this->plugin, $players);
		$this->addTeam($team);
	}
	...
	public function addTeam(Team $team){
		...
		foreach($team->getMembers() as $member){
			$member->sendMessage($team->getTeamString().TextFormat::GREEN." has been created!");
		}
	}
